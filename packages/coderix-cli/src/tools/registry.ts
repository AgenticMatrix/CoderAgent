...
useRendererByName.set('web_fetch', WebFetchRenderer);
useRendererByName.set('web_search', WebSearchRenderer);
useRendererByName.set('todo_write', TodoWriteRenderer);
useRendererByName.set('task', TaskCreateRenderer);
useRendererByName.set('task_update', TaskUpdateRenderer);
useRendererByName.set('task_list', TaskListRenderer);
useRendererByName.set('task_get', TaskGetRenderer);
...
resultRendererByName.set('task', TaskCreateResultRenderer);
resultRendererByName.set('task_get', TaskGetResultRenderer);
resultRendererByName.set('task_list', TaskListResultRenderer);
resultRendererByName.set('task_output', TaskOutputResultRenderer);
resultRendererByName.set('task_stop', TaskStopResultRenderer);
resultRendererByName.set('task_update', TaskUpdateResultRenderer);
resultRendererByName.set('web_fetch', WebFetchResultRenderer);
resultRendererByName.set('web_search', WebSearchResultRenderer);
