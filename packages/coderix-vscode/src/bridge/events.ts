...
export type GatewayEvent =
  ...
  | { payload: { request_id: string; tool_name: string; questions: Array<{ question: string; header: string; options: Array<{ label: string; description: string }> }> }; session_id?: string; type: 'question.request' }
