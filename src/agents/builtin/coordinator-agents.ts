...
export const coordinatorAgent: BuiltInAgentDefinition = {
  ...
  getSystemPrompt: () => [
    ...
    '3. Dispatch tasks to workers using team-dispatch or agent-spawn with team_name.',
    '4. Monitor progress with team-status and agent-read.',
    '5. Synthesize worker results into a coherent response for the user.',
    '',
    'Workers available:',
    ...
    '- Wait for all workers to complete before synthesizing results.',
    ...
    '- Use agent-message to communicate with running workers.',
  ].join('\n'),
};
...
export const researcherAgent: BuiltInAgentDefinition = {
  ...
  getSystemPrompt: () => [
    ...
    '- If you need clarification, use agent-message to ask the coordinator.',
    '',
...
export const implementerAgent: BuiltInAgentDefinition = {
  ...
  getSystemPrompt: () => [
    ...
    '- If blocked, use agent-message to inform the coordinator.',
    '',
...
export const testerAgent: BuiltInAgentDefinition = {
  ...
  disallowedTools: ['agent-spawn', 'NotebookEdit'],
  model: 'sonnet',
  maxTurns: 20,
